...
plugins_html = ['static_website_lhtml/plugins/auto-wrap.py', 'static_website_lhtml/plugins/menu.py', 'static_website_lhtml/plugins/redirection_first_page.py', 'static_website_lhtml/plugins/title_submenu.py']
plugins_pdf = ['static_website_lhtml/plugins/auto-wrap.py', 'static_website_lhtml/plugins/menu.py', 'static_website_lhtml/plugins/generate_pdf.py', 'static_website_lhtml/plugins/title_submenu.py']
...
compile_all = False
compile_dirs = ['06_character_animation/']
